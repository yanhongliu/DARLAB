...
class Pattern:
    ...
    p1.name2d(name2) -> match of <p1> has name2
    ...
    def get_compiled(self):
        return re.compile(self.pattern, self._flags)
    ...
    def __repr__(self):
        return '%s(%r, %r)' % (self.__class__.__name2__, self.label, self.pattern)
    ...
    def name2d(self, name2 = None):
        return self

    def rename2(self, label):
        return self
...
kind_param = digit_string | name2
kind_param_name2d = sign
signed_digit_string = ~sign + digit_string
int_literal_constant = digit_string  
signed_int_literal_constant = ~sign + int_literal_constant
int_literal_constant_name2d = sign
signed_int_literal_constant_name2d = sign
binary_constant = sign.flags(re.I)
octal_constant = sign.flags(re.I)
hex_constant = sign.flags(re.I)
boz_literal_constant = binary_constant | octal_constant | hex_constant

exponent = signed_digit_string
significand = sign
real_literal_constant = sign
real_literal_constant_name2d = sign
signed_real_literal_constant_name2d = sign
signed_real_literal_constant = ~sign + real_literal_constant

name2d_constant = sign
real_part = sign | sign
imag_part = real_part
complex_literal_constant = sign

a_n_rep_char = Pattern('<alpha-numeric-rep-char>',r'\w')
rep_char = Pattern('<rep-char>',r'.')
char_literal_constant = sign
a_n_char_literal_constant_name2d1 = sign
a_n_char_literal_constant_name2d2 = sign
logical_literal_constant = (~ (kind_param)).flags(re.I)
logical_literal_constant_name2d = Pattern('<value>',r'[.](TRUE|FALSE)[.]',flags=re.I).name2d() 
literal_constant = sign
constant = literal_constant | literal_constant
int_constant = int_literal_constant | boz_literal_constant | name2d_constant
char_constant = char_literal_constant | name2d_constant
...
intrinsic_operator = Pattern('<percent-op>',r'%',flags=re.I)
...
abs_signed_int_literal_constant_name2d = abs(signed_int_literal_constant_name2d)
abs_int_literal_constant_name2d = abs(int_literal_constant_name2d)
abs_real_literal_constant = abs(real_literal_constant)
abs_signed_real_literal_constant = abs(signed_real_literal_constant)
abs_signed_real_literal_constant_name2d = abs(signed_real_literal_constant_name2d)
abs_real_literal_constant_name2d = abs(real_literal_constant_name2d)
...
abs_name2 = abs(sign)
abs_a_n_char_literal_constant_name2d1 = abs(a_n_char_literal_constant_name2d1)
abs_a_n_char_literal_constant_name2d2 = abs(a_n_char_literal_constant_name2d2)
abs_logical_literal_constant_name2d = abs(logical_literal_constant_name2d)
abs_binary_constant = abs(binary_constant)
abs_octal_constant = abs(sign)
abs_hex_constant = abs(hex_constant)

intrinsic_type_name2 = Pattern('<intrinsic-type-name2>',r'(INTEGER|REAL|COMPLEX|LOGICAL|CHARACTER|DOUBLE\s*COMPLEX|DOUBLE\s*PRECISION|BYTE)',flags=re.I)
abs_intrinsic_type_name2 = abs(intrinsic_type_name2)
double_complex_name2 = Pattern('<double-complex-name2>','DOUBLE\s*COMPLEX', flags=re.I, value='DOUBLE COMPLEX')
double_precision_name2 = Pattern('<double-precision-name2>','DOUBLE\s*PRECISION', flags=re.I, value='DOUBLE PRECISION')
abs_double_complex_name2 = abs(double_complex_name2)
abs_double_precision_name2 = abs(double_precision_name2)
