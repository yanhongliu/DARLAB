...
class coreRBAC:
    ...
    def DeleteSsdSet(self, name):
        ...
        for tmp_23_4_1__EXPR__ in set(((name,r) for r in self.SsdRoleSetRoles(name))):
            if tmp_23_4_1__EXPR__ in self.SsdNR:
    ...
    def DeleteDsdSet(self, name):
        ...
        for tmp_23_5_1__EXPR__ in set(((name,r) for r in self.DsdRoleSetRoles(name))):
            if tmp_23_5_1__EXPR__ in self.DsdNR:
